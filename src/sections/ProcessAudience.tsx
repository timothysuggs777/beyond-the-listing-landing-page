...
const processSteps = [
  ...
  {
    num: 4,
    text: 'You receive a final release and assets to share everywhere.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
const audience = [
  ...
  {
    label: 'Teams & Agent Marketing Programs',
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
...
export default function ProcessAudience() {
  return (
    <section id="how-it-works" className={`section-light ${styles.processAudience}`}>
      <div className="container">
        {/* How It Works */}
        <div className={styles.sectionHeader}>
          <div className={styles.headerLine} />
          <h2 className={`centered ${styles.sectionTitle}`}>How It Works</h2>
          <div className={styles.headerLine} />
        </div>
        ...
        <div className={styles.sectionHeader}>
          <div className={styles.headerLine} />
          <h2 className={`centered ${styles.sectionTitle}`}>Who It&rsquo;s For</h2>
          <div className={styles.headerLine} />
        </div>
